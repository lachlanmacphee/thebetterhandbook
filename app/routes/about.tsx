  ...
  return (
    <>
      <article>
        ...
        This website has absolutely zero affiliation with Monash University.
        This is an independent, student-created platform.
      </article>
      <section>
        <h1>About</h1>
        <p>
          ...
          like. I noticed that while the handbook has important information,
          it's hard to search through and doesn't capture the real student
          experience. The Better Handbook aims to bridge this gap by providing
          advanced search functionality, peer insights about workload, teaching
          quality, and overall unit experience.
        </p>
        ...
        <p>
          The Better Handbook is completely open source, meaning anyone can
          view, contribute to, or learn from its code. I believe in transparency
          and community-driven development, which is why the entire project is
          available on{" "}
          <a
